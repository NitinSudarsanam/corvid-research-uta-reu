...
brachyrynchos_00001_1.wav,1,0,0,0,...
```
...
|-------------|----------------|--------------|
| American Crow | *Corvus brachyrynchos* | `brachyrynchos` |
...
│   │   └── features/
│   │       ├── brachyrynchos/
│   │       │   └── crow_features_audiomae_brachyrynchos.csv
│   │       └── ...
│   └── ...
└── models/
...
brachyrynchos_00001_1.wav,-0.234,0.567,...,0.123
brachyrynchos_00001_2.wav,0.145,-0.432,...,-0.067
```
...
brachyrynchos_00001_1.wav,0.95,0.02,0.01,0.02,3
brachyrynchos_00001_2.wav,0.03,0.87,0.05,0.05,7
```
